...
public class EditProfileServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String accoountId = request.getParameter("accountId");
        AccountsDAO adb = new AccountsDAO();
        ...
        Accounts old = adb.getUserById(accoountId);
//        request.setAttribute("user", old);
...
//        request.getRequestDispatcher("profile.jsp").forward(request, response);
        try {
            adb.updateUser(username, password, displayname, address, description, email, phone_number, avatar, accoountId);
