...
<%-- 
    ...
    Created on : Sep 9, 2024, 8:38:09 PM
    Author     : Norttie
--%>
    ...
    <section class="shoping-cart spad">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <form class="shoping__checkout" action="vnpay" method="post">
                        <h5>Cart Total</h5>
                        <ul>
                            <input type="text" name="amount"/><!-- this input to test payment method -->
